...
from .views import CommentCreateView, CommentDeleteView, CommentUpdateView, edit_profile_view, register_view, login_view, logout_view, profile_view, home_view, posts_view
